...
export default function AccountCard({ name, type, currency, balance, tags, meta = {} }: AccountCardProps) {
  ...
  return (
    <View className={"rounded-lg border bg-white shadow-sm relative overflow-hidden py-3 px-4 mb-4"}>
      ...
      <View className="flex flex-row justify-between items-center mb-2">
        ...
        <Text className={clsx("text-lg font-semibold", isNegative ? "text-red-600" : "text-black")}>
